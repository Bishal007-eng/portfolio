      ...
      <div className='mt-[-96px] flex flex-col justify-center items-center w-full h-full'>
        ...
        <div className='lg:max-w-[1100px] sm:max-w-[800px] w-full p-4 grid grid-cols-2 gap-8'>
          ...
          <div className='sm:text-left lg:text-center p-4'>
            <p className='text-[#91ffcb] lg:text-4xl text-2xl inline border-b-4 border-[#91ffcb] font-bold p-2 sm:mx-[10px] lg:mx-auto'>About Me</p>
          </div>
        ...
        <div className='lg:max-w-[1100px] sm:max-w-[800px] w-full grid sm:grid-cols-0 lg:grid-cols-2 gap-8 px-4'>
          ...
          <div className='sm:text-left lg:text-left lg:text-4xl text-2xl font-bold flex sm:mx-[25px] lg:mx-auto text-justify'>          
            <p className='text-gray-300'>Hello There! I'm Bishal Thapa. Nice to meet you! Please Take a look around. </p>
          </div>

          <div className='text-justify sm:mx-[25px] lg:mx-auto lg:text-2xl text-gray-400'>
            <p>
