...
export default function MiddleSection() {
  ...
  return (
    <div className='text-white'>
      ...
      <div className='max-w-[800px] mt-[-96px] w-full h-screen lg:mx-auto flex flex-col justify-center'>
        <p className='text-[#91ffcb] text-3xl font-bold p-2'>Hi there!</p>
        <h1 className='md:text-7xl sm:text-6xl text-4xl font-bold md:py-2 mx-2'>I'm Bishal Thapa</h1>
        
        <div className='flex items-center mt-2'>
          <p className=' md:text-4xl sm:text-3xl mx-2 text-xl font-bold py-2'>My skills </p>
          <ReactTyped 
        ...
        <p 
          className='md:text-xl text-xl font-bold text-gray-500 mx-2'>
          Hire me for a professional & most responsive web development with up-to-date technologies like ReactJs!
        </p>
        <div className='flex items-center'>
          <a href={Resume} download={Resume}>
            <button 
              className='text-white hover:text-black hover:bg-[#91ffcb] border-2 flex items-center rounded-md font-bold px-6 mx-2 py-2 my-6 mr-4'>
